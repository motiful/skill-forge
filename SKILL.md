...
- **Skills**: `motiful/readme-craft`, `motiful/self-review`
...
| **Maintenance** | Does the skill have 3+ dependencies, platform paths, scripts/, or >300 line body? | Generate MAINTENANCE.md | `references/maintenance-guide.md` |
...
- **Maintenance** → Generate MAINTENANCE.md with update triggers, verification steps, and changelog. See `references/maintenance-guide.md`
...
| `MAINTENANCE.md` | Generated if detected | Maintenance playbook for complex skills, see `references/maintenance-guide.md` |
...
- `references/maintenance-guide.md` — MAINTENANCE.md: when to create, required sections, template
